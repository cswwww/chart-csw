 ...
 * @LastEditTime: 2024-12-13 17:39:37
 * @FilePath: \chart-csw\src\components\chart6.vue
 * @Description: 双轨折线图
 * @Ref: https://echarts.apache.org/examples/zh/editor.html?c=line-stack
-->
<script setup>
  ...
  series: [
    {
      name: '信号强度(%)',
      type: 'line',
      stack: 'signalIntensity',
      data: props.yAxis,
    },
    {
      name: '电池电压(V)',
      type: 'line',
      stack: 'batteryVoltage',
      data: props.yAxis2,
    },
  ],
}
